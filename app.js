...
class Hero extends GameObject {
	...
	//Implementing cooldown for laser
	fire(){
...
window.onload = async () => {
	...
	heroImg = await loadTexture('assets/MainPlayer.png');
	enemyImg = await loadTexture('assets/EnemyPlayer.png');
